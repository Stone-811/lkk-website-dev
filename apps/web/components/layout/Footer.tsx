...
export default function Footer() {
  ...
  const socials = [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/linkk.tw',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/linkk.tw',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LINE',
      href: 'https://line.me/R/ti/p/@linkk',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@linkk',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-navy-700 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <span className="text-2xl font-bold text-orange font-serif">練健康</span>
            </Link>
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-medium mb-4 font-serif">導覽</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-medium mb-4 font-serif">聯絡我們</h3>
            <ul className="space-y-2 text-sm text-cream-200">
              <li>
                <a href="tel:0800-000-000" className="hover:text-white transition-colors">
                  0800-000-000
                </a>
              </li>
              <li>
                <a href="mailto:service@l-kk.tw" className="hover:text-white transition-colors">
                  service@l-kk.tw
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-navy-600 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm">
            ...
            <Link href="/terms" className="text-cream-300 hover:text-white transition-colors">
              {t('terms')}
            </Link>
          </div>
        </div>
