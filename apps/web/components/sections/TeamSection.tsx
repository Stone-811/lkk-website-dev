...
const coaches = [
  {
    ...
    role: '物理治療師・總教練',
    avatar: '鄭',
    description: '世大運場館經理、競速滑冰世界盃隨隊物理治療師，深耕中高齡運動訓練超過十年。',
    creds: ['物理治療師', '世大運', '世界盃'],
    photo: 'https://l-kk.tw/wp-content/uploads/2025/06/20250410_官網_團隊介紹_形象照-3.png',
  },
  {
    id: '2',
    name: '吳皓宇',
    role: '營養師',
    avatar: '吳',
    description: '運動營養與增肌減脂講師，新北市競速滑輪溜冰隊合作肌力體能教練，三鐵選手合作營養師。',
    creds: ['營養師', '肌力體能', '運動營養'],
    photo: 'https://l-kk.tw/wp-content/uploads/2025/06/20250410_官網_團隊介紹_形象照-3.png',
  },
  {
    ...
    role: '呼吸治療師',
    avatar: '吳',
    description: '彰化基督教醫院呼吸治療師背景，專注於呼吸功能與運動表現的整合訓練。',
    creds: ['呼吸治療師', '呼吸訓練'],
    photo: 'https://l-kk.tw/wp-content/uploads/2025/06/20250410_官網_團隊介紹_形象照-3.png',
  },
];
